...
-   Topologically, if two polygons share a boundary, they are immediate neighbours and might be defined as 'near'
...
LondonWardsMerged$z_slag_gcse <- scale(LondonWardsMerged$z_gcse)

coef(lm(average_gcse_capped_point_scores_2014 ~ slag_gcse, data = LondonWardsMerged))
p <- ggplot(LondonWardsMerged, aes(slag_gcse, average_gcse_capped_point_scores_2014))
...
```{r}
moran.test(LondonWardsMerged$average_gcse_capped_point_scores_2014, Lward.lw)
```
